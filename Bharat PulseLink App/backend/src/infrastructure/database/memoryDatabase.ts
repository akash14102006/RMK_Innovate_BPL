  ...
  if (!hasHospitals) {
    ...
    await knexInstance('hospitals').insert([
      ...
      },
      {
        ...
        specialties: 'Cardiology, Oncology, Neurology, OPD, Emergency, ICU, Pharmacy',
        facilities: 'ICU, Pharmacy, Emergency, Diagnostics',
        emergency_services: '24x7 Hospital Services',
        latitude: 13.0583,
        longitude: 80.2505,
        location: 'POINT(80.2505 13.0583)',
        coordinate_quality_status: 'VALID_COORDINATE',
      },
    ]);
  }
