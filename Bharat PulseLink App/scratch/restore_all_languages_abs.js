...
const targetPath = 'c:\\Users\\akash\\Downloads\\Bharat PulseLink App\\src\\i18n\\locales\\allLanguages.ts';
...
if (codeContent) {
  ...
  console.log('Successfully restored original allLanguages.ts via absolute path');
} else {
