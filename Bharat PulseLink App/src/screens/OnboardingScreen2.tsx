...
import OnboardingHeroScreen2 from '../components/OnboardingHeroScreen2';
import OnboardingManager from '../services/onboardingManager';
import { useI18n } from '../i18n/I18nContext';

type Props = NativeStackScreenProps<OnboardingStackParamList, 'OnboardingScreen2'>;
...
export const OnboardingScreen2: React.FC<Props> = ({ navigation }) => {
  ...
  useEffect(() => {
    console.log('[ROUTE] ONBOARDING_2');
    console.log('[ROUTE] ONBOARDING_SCREEN_2_MOUNTED');
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.heroSection}>
            <OnboardingHeroScreen2
              accessibilityLabel={t('onboarding.screen2.accessibilityHero')}
            />
          </View>
          ...
          >
            <Text style={styles.eyebrow}>{t('onboarding.screen2.eyebrow')}</Text>
