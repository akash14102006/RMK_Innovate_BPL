...
import OnboardingHeroScreen3 from '../components/OnboardingHeroScreen3';
import OnboardingManager from '../services/onboardingManager';
import { useI18n } from '../i18n/I18nContext';

type Props = NativeStackScreenProps<OnboardingStackParamList, 'OnboardingScreen3'>;
...
export const OnboardingScreen3: React.FC<Props> = ({ navigation }) => {
  ...
  useEffect(() => {
    console.log('[ROUTE] ONBOARDING_3');
    console.log('[ROUTE] ONBOARDING_SCREEN_3_MOUNTED');
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.heroSection}>
            <OnboardingHeroScreen3
              accessibilityLabel={t('onboarding.screen3.accessibilityHero')}
            />
          </View>
          ...
          >
            <Text style={styles.eyebrow}>{t('onboarding.screen3.eyebrow')}</Text>
